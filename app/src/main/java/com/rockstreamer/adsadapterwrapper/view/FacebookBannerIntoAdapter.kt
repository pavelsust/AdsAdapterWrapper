...
class FacebookBannerIntoAdapter : Fragment() {
    ...
    override fun onCreateView(
        ...
        val facebookBanner = FacebookBannerAdAdapter.Builder.with(requireActivity() , "381521685984607_1157867285016706" , listAdapter)
